...
;; [Link to code](https://github.com/coyotesqrl/advent-of-code/blob/main/src/coyotesqrl/2022/day01.clj)

(ns coyotesqrl.2022.day01
  (:require
...
;; My assumption about what the second task might have entailed was wrong. It wasn't necessary to use `map-indexed`
;; to track the position of the elf in the list.
^{::clerk/visibility {:result :hide}}
