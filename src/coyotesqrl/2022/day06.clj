...
;; [Link to code](https://github.com/coyotesqrl/advent-of-code/blob/main/src/coyotesqrl/2022/day06.clj)

(ns coyotesqrl.2022.day06
  (:require
...
(def input (utils/input->str "coyotesqrl/2022/day6-input.txt"))

;; This isn't awesome, but it'll find the marker string relatively fast
^{::clerk/visibility {:result :hide}}
